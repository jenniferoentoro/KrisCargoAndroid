 ...
 * Use the [FLCProcessFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FLCProcessFragment : Fragment() {
...
//                    val dataBaru = dataFCL(documen.data.get("bayar").toString(),documen.data.get("no_invoice").toString(),documen.data.get("tanggal_bayar").toString(),documen.data.get("tgl_invoice").toString(),documen.data.get("tgl_jatuh_tempo").toString(),documen.data.get("total_tagihan").toString())
                    ...
                    if (documen.data.get("user_id").toString() == user_id && documen.data.get("status_id").toString() == "0" && documen.data.get("tipe").toString() == "0"){
                        ada = true
                            ...
                            .addOnSuccessListener { resultSchedule ->
                                ...
                                for (docSchedule in resultSchedule){
                                    if(docSchedule.data.get("id") == sch_id){
                                        Log.d("kapal","${docSchedule.data.get("id")} == $sch_id")
                                        Log.d("firebasee3a","dapet")
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_f_l_c_process, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment FLCProcessFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FLCProcessFragment().apply {
