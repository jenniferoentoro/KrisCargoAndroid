 ...
 * Use the [LCLDeliveredFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LCLDeliveredFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_l_c_l_delivered, container, false)
    }
        ...
        db.collection("container_load").get()
            .addOnSuccessListener { result ->
                ...
                for (documen in result){
                    ...
                    if (documen.data.get("user_id").toString() == user_id && documen.data.get("status_id").toString() == "1" && documen.data.get("tipe").toString() == "1"){
                        ada = true
                        var sch_id =  documen.data.get("schedule_id")
                        Log.d("firebasee2",documen.data.get("status_id").toString())
                        Log.d("firebasee2",documen.data.get("tipe").toString())
...
//                                                        qty = docDBCL.data.get("qty").toString().toInt()
    ...
    companion object {
         ...
         * @return A new instance of fragment LCLDeliveredFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LCLDeliveredFragment().apply {
