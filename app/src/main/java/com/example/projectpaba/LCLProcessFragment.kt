 ...
 * Use the [LCLProcessFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LCLProcessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_l_c_l_process, container, false)
    }
    ...
    fun TambahData(){
        ...
        Log.d("firebasee2id",user_id.toString())
...
//                    val dataBaru = dataFCL(documen.data.get("bayar").toString(),documen.data.get("no_invoice").toString(),documen.data.get("tanggal_bayar").toString(),documen.data.get("tgl_invoice").toString(),documen.data.get("tgl_jatuh_tempo").toString(),documen.data.get("total_tagihan").toString())
                    ...
                    if (documen.data.get("user_id").toString() == user_id && documen.data.get("status_id").toString() == "0" && documen.data.get("tipe").toString() == "1"){
                        ada = true
    ...
    companion object {
         ...
         * @return A new instance of fragment LCLProcessFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LCLProcessFragment().apply {
