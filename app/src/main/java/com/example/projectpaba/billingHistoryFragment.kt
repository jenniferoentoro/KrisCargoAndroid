 ...
 * Use the [billingHistoryFragment.newInstance] factory method to
...
class billingHistoryFragment : Fragment() {
    ...
    private var arBilHistory = arrayListOf<dataBilling>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arBilHistory.clear()
        rvList = view.findViewById<RecyclerView>(R.id.rvbilHis)
            ...
            db.collection("invoice").get()
                .addOnSuccessListener { result ->
                    ...
                    for (documen in result) {
                        ...
                        if (dataBaru.bayar == dataBaru.total_tagihan && listInovice.contains(dataBaru.no_invoice) && dataBaru.total_tagihan!="0") {
                            ada2 = true
                            arBilHistory.add(dataBaru)
                    ...
                    if(ada2 == false){
                        ...
                        Log.d("firebaseSuc", arBilHistory.toString())
                        rvList.layoutManager =
                            LinearLayoutManager(view?.context, LinearLayoutManager.VERTICAL, false)
                        val adapter = adapterBillingHistory(arBilHistory)
                        rvList.adapter = adapter
                        progressBar.visibility = View.GONE
                        adapter.setOnItemClickCallBack(object :
                            adapterBillingHistory.OnItemClickCallBack {
